...
require_once('/home/sanclemente.local/dawmddwcs/Descargas/Examen 2ªAvaliación - DWCS/docker-lamp_examen/www/examen/config/Database.php');
    ...
    */
    public function getMedallero() {
        $sql="SELECT pais,
                ...
                SUM(medallas_oro*5 + medallas_plata * 2 + medallas_bronce)AS puntuacion
                FROM deportistas 
                GROUP BY pais 
