...
<body>
    ...
    <div class="menu">
        ...
        <?php
        if(!$_SESSION['nombre']=='deportista'){
            Echo 'Nombre: espectador.  Rol: user';
        }else{
            Echo 'Nombre: deportista.  Rol: admin';
        }

        ?>
        <button type="submit" href='logout.php?action=logout' >Cerrar sesión</button>
    </div>
    <div class="container">